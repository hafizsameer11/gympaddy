...
class FirebaseNotificationService
{
    ...
    {
        $this->fcmUrl = 'https://fcm.googleapis.com/v1/projects/gympaddy-96c52/messages:send';
        $this->credentialsPath = storage_path('app/json/service.json'); // Path to your Service Account key
        $this->projectId = 'gympaddy-96c52'; // Ensure you set this in your config/services.php
    }
     ...
     */
    public function sendNotification($fcmToken, $title, $body, $userId, $data = [])
    {
